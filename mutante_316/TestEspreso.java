...
public class DateRangePickerDialogFragment_Mutant_316 {

    @Rule
    public ActivityTestRule<AccountsActivity> mActivityTestRule = new ActivityTestRule<>(AccountsActivity.class);

    @Test
    public void dateRangePickerDialogFragment_Mutant_316() {
        ...
        ViewInteraction appCompatButton7 = onView(
                allOf(withId(R.id.btn_pie_chart), withText("Pie Chart"), isDisplayed()));
        appCompatButton7.perform(click());

        ViewInteraction reselectSpinner = onView(
                allOf(withId(R.id.time_range_spinner),
                        withParent(withId(R.id.time_range_layout)),
                        isDisplayed()));
        reselectSpinner.perform(click());

        ViewInteraction appCompatCheckedTextView3 = onView(
                allOf(withId(android.R.id.text1), withText("Custom range…"), isDisplayed()));
