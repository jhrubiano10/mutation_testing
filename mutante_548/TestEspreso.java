...
public class ScheduledActionsListFragment_548 {
    ...
    public void scheduledActionsListFragment_548() {
        ...
        ViewInteraction appCompatAutoCompleteTextView2 = onView(
                withId(R.id.input_transaction_name));
        appCompatAutoCompleteTextView2.perform(scrollTo(), replaceText("Agendar accion"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText2 = onView(
                withId(R.id.input_transaction_amount));
        calculatorEditText2.perform(scrollTo(), replaceText("20"), closeSoftKeyboard());
